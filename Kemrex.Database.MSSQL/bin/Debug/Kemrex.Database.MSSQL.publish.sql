/*
Deployment script for KEMREX_DEV
...
GO
:setvar DatabaseName "KEMREX_DEV"
:setvar DefaultFilePrefix "KEMREX_DEV"
...
GO
PRINT N'Dropping [dbo].[DF_TblQuotation_ValidDay]...';


GO
ALTER TABLE [dbo].[TblQuotation] DROP CONSTRAINT [DF_TblQuotation_ValidDay];


GO
PRINT N'Dropping [dbo].[DF_TblQuotation_CreditDay]...';


GO
ALTER TABLE [dbo].[TblQuotation] DROP CONSTRAINT [DF_TblQuotation_CreditDay];


GO
PRINT N'Dropping unnamed constraint on [dbo].[TblSaleOrder]...';


GO
ALTER TABLE [dbo].[TblSaleOrder] DROP CONSTRAINT [DF__TblSaleOr__Statu__6339AFF7];
...
GO
ALTER TABLE [dbo].[TblSaleOrder] DROP CONSTRAINT [DF__TblSaleOr__SaleO__62458BBE];


GO
PRINT N'Dropping [dbo].[FK_TblQuotationDetail_id]...';


GO
ALTER TABLE [dbo].[TblQuotationDetail] DROP CONSTRAINT [FK_TblQuotationDetail_id];


GO
PRINT N'Dropping [dbo].[FK_TblQuotation_Status]...';


GO
ALTER TABLE [dbo].[TblQuotation] DROP CONSTRAINT [FK_TblQuotation_Status];


GO
PRINT N'Dropping [dbo].[FK_TblQuotation_Sale]...';


GO
ALTER TABLE [dbo].[TblQuotation] DROP CONSTRAINT [FK_TblQuotation_Sale];


GO
PRINT N'Dropping [dbo].[FK_TblQuotation_Customer]...';


GO
ALTER TABLE [dbo].[TblQuotation] DROP CONSTRAINT [FK_TblQuotation_Customer];


GO
PRINT N'Dropping [dbo].[FK_TblSaleOrder_Sale]...';


GO
ALTER TABLE [dbo].[TblSaleOrder] DROP CONSTRAINT [FK_TblSaleOrder_Sale];


GO
PRINT N'Dropping [dbo].[FK_TblSaleOrder_Customer]...';


GO
ALTER TABLE [dbo].[TblSaleOrder] DROP CONSTRAINT [FK_TblSaleOrder_Customer];


GO
PRINT N'Dropping [dbo].[FK_TblInvoice_SaleOrder]...';


GO
ALTER TABLE [dbo].[TblInvoice] DROP CONSTRAINT [FK_TblInvoice_SaleOrder];


GO
PRINT N'Dropping [dbo].[FK_TblSaleOrderAttachment_Id]...';


GO
ALTER TABLE [dbo].[TblSaleOrderAttachment] DROP CONSTRAINT [FK_TblSaleOrderAttachment_Id];


GO
PRINT N'Dropping [dbo].[FK_TblSaleOrderDetail_id]...';


GO
ALTER TABLE [dbo].[TblSaleOrderDetail] DROP CONSTRAINT [FK_TblSaleOrderDetail_id];


GO
PRINT N'Starting rebuilding table [dbo].[TblQuotation]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_TblQuotation] (
    [QuotationId]        INT             IDENTITY (1, 1) NOT NULL,
    [QuotationNo]        NVARCHAR (20)   NOT NULL,
    [QuotationDate]      DATETIME        NOT NULL,
    [QuotationValidDay]  INT             CONSTRAINT [DF_TblQuotation_ValidDay] DEFAULT 30 NOT NULL,
    [ConditionId]        INT             NULL,
    [OperationStartDate] DATETIME        NULL,
    [OperationEndDate]   DATETIME        NULL,
    [DueDate]            DATETIME        NULL,
    [DeliveryDate]       DATETIME        NULL,
    [QuotationCreditDay] INT             CONSTRAINT [DF_TblQuotation_CreditDay] DEFAULT 0 NOT NULL,
    [SaleId]             INT             NOT NULL,
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_TblQuotation1] PRIMARY KEY CLUSTERED ([QuotationId] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[TblQuotation])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_TblQuotation] ON;
        INSERT INTO [dbo].[tmp_ms_xx_TblQuotation] ([QuotationId], [QuotationNo], [QuotationDate], [QuotationValidDay], [ConditionId], [DueDate], [DeliveryDate], [QuotationCreditDay], [SaleId], [SaleName], [CustomerId], [CustomerName], [ContractName], [ContractEmail], [ContractPhone], [BillingAddress], [ShippingAddress], [QuotationRemark], [DiscountCash], [StatusId], [CreatedBy], [CreatedDate], [UpdatedBy], [UpdateDate], [DeletedBy], [DeletedDate], [DeletedReason])
        SELECT   [QuotationId],
                 [QuotationNo],
                 [QuotationDate],
                 [QuotationValidDay],
        ...
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_TblQuotation] OFF;
    END

DROP TABLE [dbo].[TblQuotation];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_TblQuotation]', N'TblQuotation';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_TblQuotation1]', N'PK_TblQuotation', N'OBJECT';
...
GO
PRINT N'Starting rebuilding table [dbo].[TblSaleOrder]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_TblSaleOrder] (
    ...
    [DeliveryDate]       DATETIME        NULL,
    [SaleOrderCreditDay] INT             DEFAULT 0 NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_TblSaleOrder1] PRIMARY KEY CLUSTERED ([SaleOrderId] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[TblSaleOrder])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_TblSaleOrder] ON;
        INSERT INTO [dbo].[tmp_ms_xx_TblSaleOrder] ([SaleOrderId], [SaleOrderNo], [SaleOrderDate], [QuotationNo], [CustomerId], [CustomerName], [ContractName], [ConditionId], [PoNo], [SaleId], [SaleName], [BillingAddress], [ShippingAddress], [SaleOrderRemark], [StatusId], [CreatedBy], [CreatedDate], [UpdatedBy], [UpdateDate], [CancelReason], [DiscountCash], [DeliveryDate], [SaleOrderCreditDay])
        SELECT   [SaleOrderId],
                 [SaleOrderNo],
                 [SaleOrderDate],
                 [QuotationNo],
                 ...
                 [SaleOrderCreditDay]
        FROM     [dbo].[TblSaleOrder]
        ORDER BY [SaleOrderId] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_TblSaleOrder] OFF;
    END

DROP TABLE [dbo].[TblSaleOrder];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_TblSaleOrder]', N'TblSaleOrder';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_TblSaleOrder1]', N'PK_TblSaleOrder', N'OBJECT';
...
GO
PRINT N'Creating [dbo].[FK_TblQuotationDetail_id]...';


GO
ALTER TABLE [dbo].[TblQuotationDetail] WITH NOCHECK
    ADD CONSTRAINT [FK_TblQuotationDetail_id] FOREIGN KEY ([QuotationId]) REFERENCES [dbo].[TblQuotation] ([QuotationId]);


GO
PRINT N'Creating [dbo].[FK_TblQuotation_Status]...';


GO
ALTER TABLE [dbo].[TblQuotation] WITH NOCHECK
    ADD CONSTRAINT [FK_TblQuotation_Status] FOREIGN KEY ([StatusId]) REFERENCES [dbo].[EnmStatusQuotation] ([StatusId]);


GO
PRINT N'Creating [dbo].[FK_TblQuotation_Sale]...';


GO
ALTER TABLE [dbo].[TblQuotation] WITH NOCHECK
    ADD CONSTRAINT [FK_TblQuotation_Sale] FOREIGN KEY ([SaleId]) REFERENCES [dbo].[TblEmployee] ([EmpId]);


GO
PRINT N'Creating [dbo].[FK_TblQuotation_Customer]...';


GO
ALTER TABLE [dbo].[TblQuotation] WITH NOCHECK
    ADD CONSTRAINT [FK_TblQuotation_Customer] FOREIGN KEY ([CustomerId]) REFERENCES [dbo].[TblCustomer] ([CustomerId]);


GO
PRINT N'Creating [dbo].[FK_TblSaleOrder_Sale]...';


GO
ALTER TABLE [dbo].[TblSaleOrder] WITH NOCHECK
    ADD CONSTRAINT [FK_TblSaleOrder_Sale] FOREIGN KEY ([SaleId]) REFERENCES [dbo].[TblEmployee] ([EmpId]);


GO
PRINT N'Creating [dbo].[FK_TblSaleOrder_Customer]...';


GO
ALTER TABLE [dbo].[TblSaleOrder] WITH NOCHECK
    ADD CONSTRAINT [FK_TblSaleOrder_Customer] FOREIGN KEY ([CustomerId]) REFERENCES [dbo].[TblCustomer] ([CustomerId]);


GO
PRINT N'Creating [dbo].[FK_TblInvoice_SaleOrder]...';


GO
ALTER TABLE [dbo].[TblInvoice] WITH NOCHECK
    ADD CONSTRAINT [FK_TblInvoice_SaleOrder] FOREIGN KEY ([SaleOrderId]) REFERENCES [dbo].[TblSaleOrder] ([SaleOrderId]);


GO
PRINT N'Creating [dbo].[FK_TblSaleOrderAttachment_Id]...';


GO
ALTER TABLE [dbo].[TblSaleOrderAttachment] WITH NOCHECK
    ADD CONSTRAINT [FK_TblSaleOrderAttachment_Id] FOREIGN KEY ([SaleOrderId]) REFERENCES [dbo].[TblSaleOrder] ([SaleOrderId]);


GO
PRINT N'Creating [dbo].[FK_TblSaleOrderDetail_id]...';


GO
ALTER TABLE [dbo].[TblSaleOrderDetail] WITH NOCHECK
    ADD CONSTRAINT [FK_TblSaleOrderDetail_id] FOREIGN KEY ([SaleOrderId]) REFERENCES [dbo].[TblSaleOrder] ([SaleOrderId]);
...
GO
ALTER TABLE [dbo].[TblQuotationDetail] WITH CHECK CHECK CONSTRAINT [FK_TblQuotationDetail_id];

ALTER TABLE [dbo].[TblQuotation] WITH CHECK CHECK CONSTRAINT [FK_TblQuotation_Status];

ALTER TABLE [dbo].[TblQuotation] WITH CHECK CHECK CONSTRAINT [FK_TblQuotation_Sale];

ALTER TABLE [dbo].[TblQuotation] WITH CHECK CHECK CONSTRAINT [FK_TblQuotation_Customer];

ALTER TABLE [dbo].[TblSaleOrder] WITH CHECK CHECK CONSTRAINT [FK_TblSaleOrder_Sale];

ALTER TABLE [dbo].[TblSaleOrder] WITH CHECK CHECK CONSTRAINT [FK_TblSaleOrder_Customer];

ALTER TABLE [dbo].[TblInvoice] WITH CHECK CHECK CONSTRAINT [FK_TblInvoice_SaleOrder];

ALTER TABLE [dbo].[TblSaleOrderAttachment] WITH CHECK CHECK CONSTRAINT [FK_TblSaleOrderAttachment_Id];

ALTER TABLE [dbo].[TblSaleOrderDetail] WITH CHECK CHECK CONSTRAINT [FK_TblSaleOrderDetail_id];
