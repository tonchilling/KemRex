...
{
    public static class TeamSaleExtension
    {
        public static bool IsValid(this TeamSale ob, out string errorMsg)
        {
        ...
        public static bool IsValid(this TeamSaleDetail ob, out string errorMsg)
        {
            errorMsg = string.Empty;
            if (ob == null)
            {
