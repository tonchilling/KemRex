...
{
    public partial class TblQuotationTemplate
    {
        public TblQuotationTemplate()
        {
            TblQuotationDetailTemplate = new HashSet<TblQuotationDetailTemplate>();
        }
        ...
        public virtual ICollection<TblQuotationDetailTemplate> TblQuotationDetailTemplate { get; set; }
